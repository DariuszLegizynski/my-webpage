const BaseIcons = async ({ type, fillColor, strokeColor, width, height, strokeWidth }) => {
	return (
		<>
			{type === "phone" ? (
				<svg width={width} height={height} fill={fillColor} stroke={strokeColor} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
					<path
